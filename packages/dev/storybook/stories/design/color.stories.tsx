...
import { amber, amberAlpha } from '@lib/design/palette/amber';
import { blue, blueAlpha } from '@lib/design/palette/blue';
import { bronze, bronzeAlpha } from '@lib/design/palette/bronze';
import { brown, brownAlpha } from '@lib/design/palette/brown';
import { crimson, crimsonAlpha } from '@lib/design/palette/crimson';
import { cyan, cyanAlpha } from '@lib/design/palette/cyan';
import { gold, goldAlpha } from '@lib/design/palette/gold';
import { grass, grassAlpha } from '@lib/design/palette/grass';
import { gray, grayAlpha } from '@lib/design/palette/gray';
import { green, greenAlpha } from '@lib/design/palette/green';
import { indigo, indigoAlpha } from '@lib/design/palette/indigo';
import { iris, irisAlpha } from '@lib/design/palette/iris';
import { jade, jadeAlpha } from '@lib/design/palette/jade';
import { lime, limeAlpha } from '@lib/design/palette/lime';
import { mauve, mauveAlpha } from '@lib/design/palette/mauve';
import { mint, mintAlpha } from '@lib/design/palette/mint';
import { olive, oliveAlpha } from '@lib/design/palette/olive';
import { orange, orangeAlpha } from '@lib/design/palette/orange';
import { pink, pinkAlpha } from '@lib/design/palette/pink';
import { plum, plumAlpha } from '@lib/design/palette/plum';
import { purple, purpleAlpha } from '@lib/design/palette/purple';
import { red, redAlpha } from '@lib/design/palette/red';
import { ruby, rubyAlpha } from '@lib/design/palette/ruby';
import { sage, sageAlpha } from '@lib/design/palette/sage';
import { sand, sandAlpha } from '@lib/design/palette/sand';
import { sky, skyAlpha } from '@lib/design/palette/sky';
import { slate, slateAlpha } from '@lib/design/palette/slate';
import { teal, tealAlpha } from '@lib/design/palette/teal';
import { tomato, tomatoAlpha } from '@lib/design/palette/tomato';
import { violet, violetAlpha } from '@lib/design/palette/violet';
import { yellow, yellowAlpha } from '@lib/design/palette/yellow';
