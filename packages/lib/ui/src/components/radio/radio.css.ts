 ...
 * Radio styles.
 *
 * Ported from Radix UI Themes BaseRadio (the styling shared by Radio
 * and RadioGroup.Item). The native `<input type="radio">` is the
 * styling host: `appearance: none` strips the user-agent control,
 * `::before` paints the ring background, and `::after` paints the
