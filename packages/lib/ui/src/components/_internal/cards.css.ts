...
const classicShadowsLight = {
  rest: {
    outer: [
      ...
      `0 2px 1px -2px ${black.step1}`,
      `0 1px 3px -1px ${black.step1}`,
    ].join(', '),
    inner: [
      `0 0 0 1px ${neutral.alpha[3]}`,
      `0 0 0 1px transparent`,
      `0 0 0 0.5px ${black.step1}`,
      `0 1px 1px 0 ${neutral.alpha[2]}`,
      `0 2px 1px -1px ${black.step1}`,
      `0 1px 3px 0 ${black.step1}`,
    ].join(', '),
  },
  hover: {
    outer: [
      `0 0 0 0 ${neutral.alpha[3]}`,
      `0 1px 1px 0 ${black.step1}`,
      `0 2px 1px -2px ${neutral.alpha[3]}`,
      `0 2px 3px -3px ${black.step1}`,
      `0 3px 12px -5px ${neutral.alpha[3]}`,
      `0 4px 16px -9px ${black.step1}`,
    ].join(', '),
    inner: [
      `0 0 0 1px ${neutral.alpha[3]}`,
      `0 1px 1px 1px ${black.step1}`,
      `0 2px 1px -1px ${neutral.alpha[3]}`,
      `0 2px 3px -2px ${black.step1}`,
      `0 3px 12px -4px ${neutral.alpha[3]}`,
      `0 4px 16px -8px ${black.step1}`,
    ].join(', '),
  },
};
...
const classicShadowsDark = {
  rest: {
    outer: [
      ...
      `0 0 0 0 transparent`,
      `0 0 0 0 ${black.step3}`,
      `0 1px 1px -1px ${black.step6}`,
      `0 2px 1px -2px ${black.step6}`,
      `0 1px 3px -1px ${black.step5}`,
    ].join(', '),
    inner: [
      `0 0 0 1px ${neutral.alpha[6]}`,
      `0 0 0 1px transparent`,
      `0 0 0 0.5px ${black.step3}`,
      `0 1px 1px 0 ${black.step6}`,
      `0 2px 1px -1px ${black.step6}`,
      `0 1px 3px 0 ${black.step5}`,
    ].join(', '),
  },
  hover: {
    outer: [
