...
// emits one `:root[data-theme="<id>"]` rule per theme alongside the
// default `:root` rule. Swapping themes at runtime is a `data-theme`
// flip on `<html>` — no extra CSS fetch.
...
export { ThemeAttribute } from './theme-attribute';
