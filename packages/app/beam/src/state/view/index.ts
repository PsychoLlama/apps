/**
 * What's on screen: which surface `/beam/*` is showing, which modal is open
 * over it, and which peer the chrome is reporting on.
 *
 ...
 * far setup has got; the focused peer joins the book with the live links. Each
 * one sits above the features it draws from and folds their topics rather than
 * being folded by them, so no feature has to know a screen exists.
 *
