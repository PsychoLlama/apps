 ...
 * freed inside this module, and what crosses out of it is plain data or an
 * opaque handle bundled with the queue its callbacks fill — never a raw wasm
 * object a saga would have to remember to free.
 */
